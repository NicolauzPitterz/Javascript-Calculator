...
clearStyle = { background: "#800000" },
operatorStyle = { background: "#8d99ae" },
equalsStyle = {
  background: "#000080",
  position: "absolute",
  height: 130,
...
class Buttons extends React.Component {
  render() {
    return /*#__PURE__*/(
      ...
      React.createElement("button", { className: "x2", id: "zero", onClick: this.props.numbers, value: "0" }, "0"), /*#__PURE__*/
